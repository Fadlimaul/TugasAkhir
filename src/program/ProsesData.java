...
public class ProsesData extends javax.swing.JFrame {
    ...
    public void tabelModelSupplier(){
       ...
       tabel_supplier.setModel(tabelDataSupplier);
        try {
    ...
    public void tabelModelNormalisasi(){
       ...
       tabelNormalisasi.addColumn("Kapasitas");
       tabelNormalisasi.addColumn("Kualitas");
       tabelNormalisasi.addColumn("Pelayanan");
    ...
    public  void normalisasi(){
        ...
        try{
            ...
            ResultSet res2 = conn.ambilData("select *"+"from "+"tbl_supplier ");
            tabelModelNormalisasi();
