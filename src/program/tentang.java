...
public class tentang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Sistem ini dibangun untuk menyelesaikan Tugas Akhir di Program Studi Teknik Informatika\nFakultas Teknik dan Ilmu Komputer \nUniversitas Indraprasta PGRI \t\n\nKriteria yang digunakan antara lain :\nHarga, Kapasitas, Kualitas, dan Pelayanan.\nBobot dari masing - masing kriteria adalah ( 30%, 25%, 30%, 15% )\n\nMetode yang digunakan adalah SAW (Simple Additive Weighting)");
